		...
		init:function(env){
			...
			*/
			...
			$div.click(function(){
				...
				'</li>'+
				'<li class="nav-item">'+
				'<a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Browse among uploaded</a>'+
				'</li>'+
				'<li class="nav-item">'+
				'<a id="close-image-upload" class="nav-link float-right" href="#">close</a>'+
				'</li>'+
				'</ul>'+
				'<div class="tab-content" id="myTabContent">'+
				'<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">'+
				'<div id="bedusUpload">Upload File</div>'+
